      ...
      <div className="contact__container container grid">
        <div className="contact__data">
          ...
          <div className="contact__info">
            <div className="info__item">
              ...
              <div>
                ...
                <h4 className="info__desc">stivinmavelil@gmail.com</h4>
              </div>
            </div>
            ...
            <div className="info__item">
              ...
              <div>
                ...
                <h4 className="info__desc">+4479817135</h4>
              </div>
            </div>
          </div>
          ...
          <div className="contact__socials">
            <a
              href="https://github.com/Astranag/"
              className="contact__social-link"
            >
              <FaGithub />
            </a>
            <a
              href="https://www.linkedin.com/in/stivin-james-mavelil-07a9b1161/"
              className="contact__social-link"
            >
              <FaLinkedin />
            </a>
            <a
              href="https://www.instagram.com/stivinjm?igsh=MW1icTQxdW5sdHMwNA=="
              className="contact__social-link"
            >
              <FaInstagram />
            </a>
